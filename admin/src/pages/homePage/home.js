...
const Home = () => {
    ...
    return (
        <div style={{backgroundColor:"lavender" ,height:"100vh"}}>
            <hr/>
            <h1>Flight List</h1>
            <Button sx={{width:'180px', position:'absolute', top:'40px', right:'20px'}} variant="contained" onClick={() => nav("/add-flight") }>Add Flight</Button>
            <hr></hr>
            ...
            {Flight.map((flight,index) => {
                return (
                       <div key={ids[index]} className="Data-Container">
                        ...
                        <div>
                            <Button variant="contained" onClick={() => nav(`/booking-list/${ids[index]}`)} sx={{height:"40px", width:"180px", marginTop:"35px"}}>View Bookings</Button>
                        </div>
                       </div>
